...
Future<void> info(CommandContext ctx) async {
  ...
  var embed = EmbedBuilder()
    ..addField(name: "Uptime", content: "${bot.uptime.inMinutes} min", inline: true)
      //Big thanks to lib dev (l7ssha) and the power of ctrl + f for memory usage 
    ..addField(name: "DartVM memory usage", content: "$memUsage MB", inline: true)
    ..addField(name: "Guild count", content: "${bot.guilds.count}", inline: true)
